		...
		<div class="center">
    		<div class="previous">
				...
				?>
                	...
                	<p class="previous-label"><?php echo __("Vorheriger Beitrag","uslang"); ?></p>
			...
			<div class="overview">
                  <a class="btn btn-primary" href="<?php echo get_permalink($pfp); ?>"><?php echo __("Zur Übersicht","uslang"); ?></a>
            </div>
			<div class="next">
				<?php
				...
				?>
                	...
                	<p class="next-label"><?php echo __("Nächster Beitrag", "uslang"); ?></p>
